...
import io.github.rafaelcorsini.study.rest.dto.AtualizacaoStatusPedidoDTO;
import io.github.rafaelcorsini.study.rest.dto.InformacaoItemPedidoDTO;
import io.github.rafaelcorsini.study.rest.dto.InformacoesPedidoDTO;
...
public class PedidoController {
	...
	private InformacoesPedidoDTO converter(Pedido pedido) {
		return InformacoesPedidoDTO
					...
					.items(converter(pedido.getItems())).build();
	}
